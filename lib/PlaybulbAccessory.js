...
class PlaybulbAccessory {
    constructor(log, config) {
        ...
        this.internalColor = Color({r: 255, g: 255, b: 255});
    ...
    writeAndTransition() {
        ...
        colorTransitions(this.internalColor.rgb(), rgb, {duration: 200}, color => {
            ...
            this.internalColor = Color({r: color[0], g: color[1], b: color[2]}).hsv();
            var buf = Buffer.from([0, round(color[0]), round(color[1]), round(color[2])]);
